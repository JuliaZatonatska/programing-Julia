...
// Реалізація Б: ARRAY LOOKUP (Direct Access)
...
void runBenchmark() {
    long long iterations = 10000000; // 10 мільйонів ітерацій
    int dummyMonth = 9; // Вересень
    ...
    for (long long i = 0; i < iterations; ++i) {
        ...
        // Запобігаємо оптимізації (щоб компілятор не викинув цикл)
